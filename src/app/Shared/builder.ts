...
export class CharacterBuilder {
  static create( build: Character ) {
    return {
      ...
      lifeForce: build.lifeForce,
      agility: build.agility,
      wisdom: build.wisdom,
      spirit: build.spirit,
      seduction: build.seduction,
      leadership: build.leadership,
      acrobatics: build.acrobatics,
      athletics: build.athletics,
      clandestine: build.clandestine,
      computers: build.computers,
      disguise: build.disguise,
      engineering: build.engineering,
      intimidate: build.intimidate,
      intuition: build.intuition,
      lifeScience: build.lifeScience,
      medicine: build.medicine,
      mysticism: build.mysticism,
      piloting: build.piloting,
      stealth: build.stealth,
      staminaPoints: build.staminaPoints,
      healthPoints: build.healthPoints,
      resolvePoints: build.resolvePoints,
      ...
      battlesFought: build.battlesFought
    };
  }
}
